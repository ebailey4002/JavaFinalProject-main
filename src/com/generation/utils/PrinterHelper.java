...
public class PrinterHelper
{
        ...
        throws ParseException
    {
        ...
        JavaNetHttpCookieAccess formatter; //From Adam - logic -- this while loop is checking if date insertion is valid if not, will print error. If it is, the method will accept the input. Need to further understand scanner.
        while(!validDate){
            System.out.println( "| Enter student birth date(mm/dd/yyyy)|" );
            try {
